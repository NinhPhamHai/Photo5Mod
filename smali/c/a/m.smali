...
.field public static final g:Lc/a/m;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lc/a/m;->g:Lc/a/m;
    ...
    .line 3
    invoke-static {v2}, Lb/d/a/b/c/o/q/b;->a(I)I
...
.method public a(Lj/n/f;Ljava/lang/Runnable;)V
    ...
    .line 1
    :try_start_0
    sget-object p1, Lc/a/m;->pool:Ljava/util/concurrent/Executor;
    ...
    :cond_0
    invoke-virtual {p0}, Lc/a/m;->r()Ljava/util/concurrent/Executor;
...
.method public final k()Ljava/util/concurrent/ExecutorService;
    ...
    .line 2
    invoke-virtual {p0}, Lc/a/m;->s()I

    move-result v1

    new-instance v2, Lc/a/m$a;

    invoke-direct {v2, v0}, Lc/a/m$a;-><init>(Ljava/util/concurrent/atomic/AtomicInteger;)V
...
.method public final p()Ljava/util/concurrent/ExecutorService;
    ...
    invoke-virtual {p0}, Lc/a/m;->k()Ljava/util/concurrent/ExecutorService;
    ...
    .line 5
    sget-object v5, Lc/a/m;->g:Lc/a/m;

    if-eqz v5, :cond_6

    .line 6
    sget-object v5, Lc/a/n;->e:Lc/a/n;
    ...
    sget-object v3, Lc/a/m;->g:Lc/a/m;

    invoke-virtual {v3}, Lc/a/m;->s()I
...
.method public final declared-synchronized r()Ljava/util/concurrent/Executor;
    ...
    .line 1
    :try_start_0
    sget-object v0, Lc/a/m;->pool:Ljava/util/concurrent/Executor;
    ...
    :cond_0
    invoke-virtual {p0}, Lc/a/m;->p()Ljava/util/concurrent/ExecutorService;

    move-result-object v0

    sput-object v0, Lc/a/m;->pool:Ljava/util/concurrent/Executor;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
